...
const u8 gMenuText_ToggleUniqueMega[] = _("Toggle");
...
const u8 gText_ToggleUniqueMega[] = _("Allow Unique Megas switch to their \ndefault Mega Ability?");
const u8 gText_ToggleUniqueMega_Yes[] = _("Unique Mega keeps its default Mega \nAbility");
const u8 gText_ToggleUniqueMega_No[] = _("Unique Mega retains its current Ability");
