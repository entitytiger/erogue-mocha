...
// safariMons slots:
// 0-54 are for regular mons
// 55-79 are for legends
#define ROGUE_SAFARI_TOTAL_MONS             85
#define ROGUE_SAFARI_LEGENDS_START_INDEX    60
#define ROGUE_SAFARI_TOTAL_CUSTOM_MONS      25
